  ...
  Widget build(BuildContext context) {
    ...
    if (!kIsWeb && Platform.isAndroid) {
      return Form(
        key: _formKey,
        child: AbsorbPointer(
          absorbing: ref.watch(loginProvider).isLoading,
          child: Card(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Text('or', style: TextStyle(color: colorScheme.primary)),
                      Expanded(child: Divider(color: colorScheme.primary)),
                    ],
                  ),
                  SizedBox(height: 10),
                  ref
                      .watch(themeProvider)
                      .maybeWhen(
                        data: (themeMode) => GestureDetector(
                          onTap: googleSignIn,
                          child: switch (themeMode) {
                            ThemeMode.dark => SvgPicture.asset(
                              "assets/web_dark_sq_ctn.svg",
                              height: 50,
                            ),
                            ThemeMode.light => SvgPicture.asset(
                              "assets/web_light_sq_ctn.svg",

                              height: 50,
                            ),
                            ThemeMode.system => SvgPicture.asset(
                              "assets/web_light_sq_ctn.svg",
                              height: 50,
                            ),
                          },
